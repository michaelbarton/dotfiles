...
Explain what this file does as if describing it to a colleague who understands
software but has no context on this project. Cover:
...
- Notable decisions: non-obvious implementation choices, trade-offs, or
  constraints

Reference specific line numbers and identifiers. Do not restate Part 1 in
technical language — add new information.
